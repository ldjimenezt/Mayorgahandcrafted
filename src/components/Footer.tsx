    ...
    <div className="py-24 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 relative bg-gray-100 text-sm mt-24">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          <Link href="/">
            <div className="text-2xl tracking-wide">MAYORGA</div>
          </Link>
          <p>3252 Ecuador, Otavalo, Plaza de Ponchos, CA 90210</p>
          <span className="font-semibold">info@mayorga.com</span>
          <span className="font-semibold">+593 525 52 525 52</span>
          ...
          <div className="flex">
            <form className="flex w-full" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="p-4 w-3/4 border border-gray-300 rounded-l-lg"
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div>© 2024 Mayorga Handcrafter</div>
        <div className="flex flex-col gap-8 md:flex-row">
          <div>
            <span className="text-gray-500 mr-4">Language</span>
            <span className="font-medium">Ecuador | English</span>
          </div>
          <div>
